    ...
    return (
        <div ref={ref} className="relative">
            <button
                ...
                className={`flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium transition-colors duration-150 cursor-pointer ${isFiltered
            ...
            {open && (
                <div className="absolute right-0 bottom-full mb-1 w-52 max-h-64 overflow-y-auto bg-slate-800/95 backdrop-blur-2xl border border-white/12 rounded-xl shadow-[0_12px_40px_rgba(0,0,0,0.5)] animate-fadeIn z-10">
