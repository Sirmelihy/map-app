        ...
        <Collapsible open={isOpen} onOpenChange={setIsOpen}>
            ...
            >
                ...
                <CollapsibleTrigger asChild>
                    <div className="flex items-center justify-between px-5 h-[44px] bg-card border-t border-x border-border rounded-t-xl cursor-pointer select-none hover:bg-accent transition-colors">
                            ...
                            {filtered.length > 0 ? (
                                filtered.map((venue) => (
                                    <Card
                                        ...
                                        className="shrink-0 w-40 p-0 gap-0 cursor-pointer transition-all hover:shadow-md hover:scale-[1.02] group"
                                    >
